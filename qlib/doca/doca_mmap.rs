...
extern "C" {
    #[doc = " @brief Get the user_data of a DOCA Memory Map.\n\n @note The user_data that was provided to the mmap upon its creation.\n\n @param [in] mmap\n The DOCA memory map structure.\n @param [out] user_data\n The user_data of mmap.\n\n @return\n DOCA_SUCCESS - in case of success.\n doca_error code - in case of failure:\n - DOCA_ERROR_INVALID_VALUE - if an invalid input had been received."]
    pub fn doca_mmap_get_user_data(mmap: *mut doca_mmap, user_data: *mut doca_data)
        -> doca_error_t;
}
extern "C" {
    #[doc = " @brief Get the max number of chunks to populate in a DOCA Memory Map.\n\n @param [in] mmap\n The DOCA memory map structure.\n @param [out] max_num_chunks\n The max number of chunks to populate in mmap.\n\n @return\n DOCA_SUCCESS - in case of success.\n doca_error code - in case of failure:\n - DOCA_ERROR_INVALID_VALUE - if an invalid input had been received."]
    pub fn doca_mmap_get_max_num_chunks(
        mmap: *mut doca_mmap,
        max_num_chunks: *mut u32,
    ) -> doca_error_t;
}
extern "C" {
    #[doc = " @brief Get the max number of devices to add to a DOCA Memory Map.\n\n @param [in] mmap\n The DOCA memory map structure.\n @param [out] max_num_devices\n The max number of devices that can be added add to mmap.\n\n @return\n DOCA_SUCCESS - in case of success.\n doca_error code - in case of failure:\n - DOCA_ERROR_INVALID_VALUE - if an invalid input had been received."]
    pub fn doca_mmap_get_max_num_devices(
        mmap: *mut doca_mmap,
        max_num_devices: *mut u32,
    ) -> doca_error_t;
}
extern "C" {
    #[doc = " @brief Get the Total number of `struct doca_buf` objects pointing to the memory in a DOCA Memory Map.\n\n @param [in] mmap\n The DOCA memory map structure.\n @param [out] num_bufs\n The total number of `struct doca_buf` objects pointing to the memory in mmap.\n\n @return\n DOCA_SUCCESS - in case of success.\n doca_error code - in case of failure:\n - DOCA_ERROR_INVALID_VALUE - if an invalid input had been received."]
    pub fn doca_mmap_get_num_bufs(mmap: *mut doca_mmap, num_bufs: *mut u32) -> doca_error_t;
}
extern "C" {
    #[doc = " @brief Get the flag indicating if a DOCA Memory Map had been exported.\n\n @param [in] mmap\n The DOCA memory map structure.\n @param [out] exported\n 1 if mmap had been exported, 0 otherwise.\n\n @return\n DOCA_SUCCESS - in case of success.\n doca_error code - in case of failure:\n - DOCA_ERROR_INVALID_VALUE - if an invalid input had been received."]
    pub fn doca_mmap_get_exported(mmap: *mut doca_mmap, exported: *mut u8) -> doca_error_t;
}
extern "C" {
    #[doc = " @brief Get the flag indicating if a DOCA Memory Map had been created from an export.\n\n @param [in] mmap\n The DOCA memory map structure.\n @param [out] from_export\n 1 if mmap had been created from export, 0 otherwise.\n\n @return\n DOCA_SUCCESS - in case of success.\n doca_error code - in case of failure:\n - DOCA_ERROR_INVALID_VALUE - if an invalid input had been received."]
    pub fn doca_mmap_get_from_export(mmap: *mut doca_mmap, from_export: *mut u8) -> doca_error_t;
}
extern "C" {
    #[doc = " @brief Set a new max number of chunks to populate in a DOCA Memory Map.\n Note: once a memory map object has been first started this functionality will not be available.\n\n @param [in] mmap\n The DOCA memory map structure.\n @param [in] max_num_chunks\n The new max number of chunks to populate in mmap.\n\n @return\n DOCA_SUCCESS - in case of success.\n doca_error code - in case of failure:\n - DOCA_ERROR_INVALID_VALUE - if an invalid input had been received.\n - DOCA_ERROR_NOT_PERMITTED - if trying to set the max number of chunks after first start of the mmap."]
    pub fn doca_mmap_set_max_num_chunks(mmap: *mut doca_mmap, max_num_chunks: u32) -> doca_error_t;
}
extern "C" {
    #[doc = " @brief Set a new max number of devices to add to a DOCA Memory Map.\n Note: once a memory map object has been first started this functionality will not be available.\n\n @param [in] mmap\n The DOCA memory map structure.\n @param [in] max_num_devices\n The new max number of devices that can be added add to mmap.\n\n @return\n DOCA_SUCCESS - in case of success.\n doca_error code - in case of failure:\n - DOCA_ERROR_INVALID_VALUE - if an invalid input had been received.\n - DOCA_ERROR_NOT_PERMITTED - if trying to set the max number of devices after first start of the mmap."]
    pub fn doca_mmap_set_max_num_devices(
        mmap: *mut doca_mmap,
        max_num_devices: u32,
    ) -> doca_error_t;
}
