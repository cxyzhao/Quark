...
//bindgen --with-derive-default  ./dma_copy_core.h  -o /home/cxyzhao/host-quark/Quark/dma_copy_core.rs -- -I/opt/mellanox/doca/include
//Note: need to add some impl for opaque structure
