...
impl Default for doca_pci_bdf__bindgen_ty_1 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[doc = " @brief Opaque structure representing a data buffer, that can be read by registered DOCA devices."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct doca_buf {
    _unused: [u8; 0],
}
pub const doca_buf_extension_DOCA_BUF_EXTENSION_NONE: doca_buf_extension = 0;
#[doc = "< Linked list extension"]
pub const doca_buf_extension_DOCA_BUF_EXTENSION_LINKED_LIST: doca_buf_extension = 1;
pub type doca_buf_extension = ::std::os::raw::c_uint;
extern "C" {
    #[doc = " @brief Increase the object reference count by 1.\n\n @param [in] buf\n DOCA Buf element.\n @param [out] refcount\n The number of references to the object before this operation took place.\n\n @return\n - DOCA_ERROR_NOT_SUPPORTED\n\n @note This function is not supported yet."]
    pub fn doca_buf_refcount_add(buf: *mut doca_buf, refcount: *mut u16) -> doca_error_t;
}
extern "C" {
    #[doc = " @brief Decrease the object reference count by 1, if 0 reached, return the element back to the inventory.\n\n @details When refcont 0 reached, all related resources should be released. For example if the element points into\n some mmap its state will be adjusted accordingly.\n If DOCA_BUF_EXTENSION_LINKED_LIST is selected the buf must be the head of a list\n\n @param [in] buf\n DOCA Buf element.\n @param [out] refcount\n The number of references to the object before this operation took place.\n\n @return\n DOCA_SUCCESS - in case of success.\n doca_error code - in case of failure:\n - DOCA_ERROR_INVALID_VALUE - if an invalid input had been received."]
    pub fn doca_buf_refcount_rm(buf: *mut doca_buf, refcount: *mut u16) -> doca_error_t;
}
extern "C" {
    #[doc = " @brief Get the reference count of the object.\n\n @param [in] buf\n DOCA Buf element.\n @param [out] refcount\n The number of references to the object.\n\n @return\n DOCA_SUCCESS - in case of success.\n doca_error code - in case of failure:\n - DOCA_ERROR_INVALID_VALUE - if an invalid input had been received."]
    pub fn doca_buf_get_refcount(buf: *mut doca_buf, refcount: *mut u16) -> doca_error_t;
}
extern "C" {
    #[doc = " @brief Get the buffer's length.\n\n @param [in] buf\n DOCA Buf element.\n @param [out] len\n The length of the buffer.\n\n @return\n DOCA_SUCCESS - in case of success.\n doca_error code - in case of failure:\n - DOCA_ERROR_INVALID_VALUE - if an invalid input had been received."]
    pub fn doca_buf_get_len(buf: *mut doca_buf, len: *mut usize) -> doca_error_t;
}
extern "C" {
    #[doc = " @brief Get lkey with doca_access_flags access for a DOCA buffer of a DOCA device.\n\n @param [in] buf\n The DOCA buffer to get lkey for.\n\n @param [in] dev\n The DOCA device to get lkey for.\n\n @param [in] doca_access_flags\n LKey access flags (see enum doca_access_flags).\n\n @param [out] lkey\n The returned LKey.\n\n @return\n DOCA_SUCCESS - in case of success.\n doca_error code - in case of failure:\n - DOCA_ERROR_INVALID_VALUE - if an invalid input had been received or if cannot find mkey by the given device.\n - DOCA_ERROR_NOT_SUPPORTED - if the given access flags is not supported"]
    pub fn doca_buf_get_lkey(
        buf: *const doca_buf,
        dev: *mut doca_dev,
        doca_access_flags: u32,
        lkey: *mut u32,
    ) -> doca_error_t;
}
extern "C" {
    #[doc = " @brief Get the buffer's head.\n\n @param [in] buf\n DOCA Buf element.\n @param [out] head\n The head of the buffer.\n\n @return\n DOCA_SUCCESS - in case of success.\n doca_error code - in case of failure:\n - DOCA_ERROR_INVALID_VALUE - if an invalid input had been received."]
    pub fn doca_buf_get_head(
        buf: *mut doca_buf,
        head: *mut *mut ::std::os::raw::c_void,
    ) -> doca_error_t;
}
extern "C" {
    #[doc = " @brief Get buffer's data length.\n\n @param [in] buf\n DOCA Buf element.\n @param [out] data_len\n The data length of the buffer.\n\n @return\n DOCA_SUCCESS - in case of success.\n doca_error code - in case of failure:\n - DOCA_ERROR_INVALID_VALUE - if an invalid input had been received."]
    pub fn doca_buf_get_data_len(buf: *mut doca_buf, data_len: *mut usize) -> doca_error_t;
}
extern "C" {
    #[doc = " @brief Get the buffer's data.\n\n @param [in] buf\n DOCA Buf element.\n @param [out] data\n The data of the buffer.\n\n @return\n DOCA_SUCCESS - in case of success.\n doca_error code - in case of failure:\n - DOCA_ERROR_INVALID_VALUE - if an invalid input had been received."]
    pub fn doca_buf_get_data(
        buf: *mut doca_buf,
        data: *mut *mut ::std::os::raw::c_void,
    ) -> doca_error_t;
}
extern "C" {
    #[doc = " Set data pointer and data length\n\n\n         +-----------+-----+-----------------+\n Before  |           |data |                 |\n         +-----------+-----+-----------------+\n\n                 __data_len__\n                /            \\\n         +-----+--------------+--------------+\n After   |     |data          |              |\n         +-----+--------------+--------------+\n              /\n            data\n\n @param [in] buf\n DOCA Buf element.\n @param [in] data\n Data address.\n @param [in] data_len\n Data length.\n\n @return\n DOCA_SUCCESS - in case of success.\n doca_error code - in case of failure:\n - DOCA_ERROR_INVALID_VALUE - if an invalid input had been received\n                              or if data address and length are outside buffer's limits."]
    pub fn doca_buf_set_data(
        buf: *mut doca_buf,
...
fn bindgen_test_layout_dma_copy_cfg() {
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).cpy_num) as usize - ptr as usize },
        156usize,
        concat!(
            "Offset of field: ",
            stringify!(dma_copy_cfg),
...
extern "C" {
    pub fn populate_and_export_local_buffer(
        dma_cfg: *mut dma_copy_cfg,
        core_state: *mut core_state,
        buffer: *mut ::std::os::raw::c_char,
        buffer_len: u32,
...
extern "C" {
    pub fn inventory_buf(
        core_state: *mut core_state,
        remote_mmap: *mut doca_mmap,
        host_dma_addr: *mut ::std::os::raw::c_char,
        host_dma_offset: usize,
        remote_doca_buf: *mut doca_buf,
    ) -> doca_error_t;
}
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
...
impl  doca_dev_rep {
    pub fn new() -> doca_dev_rep {
        doca_dev_rep { _unused: [] }
    }
}
impl  doca_comm_channel_addr_t {
    pub fn new() ->  doca_comm_channel_addr_t {
        doca_comm_channel_addr_t { _unused: [] }
    }
}
impl  doca_buf {
    pub fn new() ->  doca_buf {
